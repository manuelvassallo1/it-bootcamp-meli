...
import com.meli.tucasita.exceptions.PropertyException;
import com.meli.tucasita.exceptions.model.ErrorDTO;
import com.meli.tucasita.exceptions.model.FieldErrorDTO;
...
public class PropertyExceptionController {
    ...
    protected ResponseEntity<ErrorDTO> handleAPIExceptions(PropertyException e) {
